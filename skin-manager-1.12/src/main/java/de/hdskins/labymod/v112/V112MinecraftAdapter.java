...
public class V112MinecraftAdapter implements MinecraftAdapter {
    ...
    public void fillSettings(List<SettingsElement> list, ConfigObject object) {
        ...
        serverUrlElement.setDescriptionText("The admin token to bypass rate limits if available");
        ...
        ButtonElement controlElement = new V112ButtonElement("Change skin", new ControlElement.IconData(Material.PAINTING), "Click here");
